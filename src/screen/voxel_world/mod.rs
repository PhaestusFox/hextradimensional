...
// pub enum BlockTypeOld {
//     Basic(BasicBlock),
//     Complex(ComplexBlock),
// }

// impl Debug for BlockTypeOld {
//     fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
//         match self {
//             BlockTypeOld::Basic(block) => f.write_fmt(format_args!("{:?}", block)),
//             BlockTypeOld::Complex(block) => f.write_fmt(format_args!("{:?}", block)),
//         }
//     }
// }
